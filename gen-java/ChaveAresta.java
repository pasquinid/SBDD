...
public class ChaveAresta implements org.apache.thrift.TBase<ChaveAresta, ChaveAresta._Fields>, java.io.Serializable, Cloneable, Comparable<ChaveAresta> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ChaveAresta");
  ...
  private static final org.apache.thrift.protocol.TField HASH_FIELD_DESC = new org.apache.thrift.protocol.TField("hash", org.apache.thrift.protocol.TType.I32, (short)3);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new ChaveArestaStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ChaveArestaTupleSchemeFactory());
  }
  ...
  private static final int __HASH_ISSET_ID = 2;
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ChaveAresta.class, metaDataMap);
  }
   ...
   */
  public ChaveAresta(ChaveAresta other) {
  ...
  public ChaveAresta deepCopy() {
    return new ChaveAresta(this);
  }
  ...
  public ChaveAresta setVertice1(int vertice1) {
    this.vertice1 = vertice1;
    setVertice1IsSet(true);
    return this;
  }
  ...
  public ChaveAresta setVertice2(int vertice2) {
    this.vertice2 = vertice2;
    setVertice2IsSet(true);
    return this;
  }
  ...
  public ChaveAresta setHash(int hash) {
    this.hash = hash;
    setHashIsSet(true);
    return this;
  }
  ...
  public void unsetHash() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __HASH_ISSET_ID);
  }

  /** Returns true if field hash is set (has been assigned a value) and false otherwise */
  public boolean isSetHash() {
    return EncodingUtils.testBit(__isset_bitfield, __HASH_ISSET_ID);
  }

  public void setHashIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __HASH_ISSET_ID, value);
  }
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case HASH:
      return Integer.valueOf(getHash());
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ChaveAresta)
      return this.equals((ChaveAresta)that);
    return false;
  }

  public boolean equals(ChaveAresta that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ChaveAresta other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ChaveAresta(");
    boolean first = true;
  ...
  private static class ChaveArestaStandardSchemeFactory implements SchemeFactory {
    public ChaveArestaStandardScheme getScheme() {
      return new ChaveArestaStandardScheme();
    }
  }

  private static class ChaveArestaStandardScheme extends StandardScheme<ChaveAresta> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ChaveAresta struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ChaveAresta struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ChaveArestaTupleSchemeFactory implements SchemeFactory {
    public ChaveArestaTupleScheme getScheme() {
      return new ChaveArestaTupleScheme();
    }
  }

  private static class ChaveArestaTupleScheme extends TupleScheme<ChaveAresta> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ChaveAresta struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ChaveAresta struct) throws org.apache.thrift.TException {
